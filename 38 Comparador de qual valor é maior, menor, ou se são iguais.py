# Escreva um programa que leia dois números inteiros e compare-os. mostrando na tela uma mensagem: - O primeiro
...
if n1 > n2:
    ...
    print('O primeiro valor "{}" é igual ao segundo valor.'.format(n1))
else:
